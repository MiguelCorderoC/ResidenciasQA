...
function EstadosClientesCreateView() {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      toast.success("Estado de cliente registrado");
    } catch (error) {
      toast.error("Error al registrar estado de cliente");
      console.error(error);
    }
  };
...
export default EstadosClientesCreateView;
